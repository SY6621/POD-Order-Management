...
# 来自在线调试页面的数据
ONLINE_TIMESTAMP = "1773043653299"
ONLINE_SIGN = "b9b6e68915bb56ab2ad634f0e11bc7d8"
...
print("=" * 60)
print("使用在线调试页面的签名测试API")
print("=" * 60)
print(f"\n时间戳: {ONLINE_TIMESTAMP}")
print(f"签名: {ONLINE_SIGN}")
print(f"\n请求URL: {BASE_URL}")
