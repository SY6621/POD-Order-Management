...
## 更新摘要
**所做更改**
- 更新了架构简化说明：移除了双令牌安全系统，现在采用简化的单令牌设计
- 移除了完整的邮件自动化框架和AI邮件生成功能
- 更新了系统特色描述，反映简化的功能集
- 更新了安全机制章节，删除双令牌验证相关内容
- 更新了前端界面设计，移除AI回复生成和邮件模板管理功能
- 更新了API接口规范，删除设计链接专用接口
- 更新了数据库设计，移除设计链接相关字段和表
...
**更新** 系统现已简化为单令牌设计，移除了双令牌安全系统和完整的邮件自动化框架，专注于核心的订单管理和设计修改功能。

### 系统特色

- **双链接架构**：提供两个独立的客服访问入口，分别专注于不同的业务场景
- **简化令牌机制**：采用简化的单令牌设计，确保链接访问的安全性
...
设计链接界面提供专业的设计修改环境，移除了AI回复生成和邮件模板管理功能：
...
MainContent[主内容区]
LeftColumn[左侧列：设计器区域]
RightColumn[右侧列：订单详情和操作面板]
...
1. **设计器区域**：集成独立的SVG设计器，支持实时效果预览
2. **订单详情面板**：显示产品图片、订单号、客户信息、文字内容等
3. **操作按钮区域**：包含保存草稿和标记已处理功能
...
**更新** 设计链接专用接口已被移除，设计链接现在使用相同的验证机制
...
客服外链双链接系统通过架构简化，为Etsy订单管理提供了高效、安全、易用的解决方案。系统的主要优势包括：
